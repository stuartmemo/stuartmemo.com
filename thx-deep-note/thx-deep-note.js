...
var addWobble = function (osc) {
    ...
    osc.frequency(currentFrequency, 0);

    for (var i = 0; i < total_wobbles; i++) {
        //osc.sourceNode.frequency.linearRampToValueAtTime(currentFrequency + getRandomInt(-100, 100), tsw.now() + sound_length - getRandomInt(1, 8));
    }
};
