...
<p class="title">Edit News Story</p>
<% while ((Repeat1__numRows-- != 0) && (!Recordset1.EOF)) { %>
<p><A HREF="/Admin/editstory.asp?<%= MM_keepURL + ((MM_keepURL!="")?"&":"") + "id=" + Recordset1.Fields.Item("id").Value %>" class="headline"><%=(Recordset1.Fields.Item("headline").Value)%></A><br>
