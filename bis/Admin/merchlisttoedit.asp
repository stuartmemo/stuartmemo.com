...
<p><span class="title"> Edit Merchandise Item</span></p>
<% while ((Repeat1__numRows-- != 0) && (!rsMerch.EOF)) { %>
<table width="243" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="154" class="headline"><A HREF="/Admin/editmerch.asp?<%= MM_keepURL + ((MM_keepURL!="")?"&":"") + "id=" + rsMerch.Fields.Item("id").Value %>"><%=(rsMerch.Fields.Item("Item").Value)%></A></td>
