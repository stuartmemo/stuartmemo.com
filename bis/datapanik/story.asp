  ...
  <tr>
    <td><table width="584" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td valign="top" bgcolor="#A39A7B"><span class="bodycopy"><table width=100% border=0 cellpadding=0 cellspacing=4 bordercolor="#CCCCCC" bgcolor="a39a7b" class=text>
              <tr>
                <td valign=top width=1 class="title"><img src="images/spacer.gif" width="1" height="1"></td>
                <td valign=top width=500 class="title"> <p><span class="headline"><%=(Recordset1.Fields.Item("headline").Value)%></span><br />
                    <span class="dateline"><%=(Recordset1.Fields.Item("calendar").Value)%></span><br />
                    <span class="bodycopy"><%=(Recordset1.Fields.Item("body").Value)%></span><br />
                  <p><a href="listall.asp" ><span class="listall">List 
                    All</span></a></p>
                  </td>
              </tr>
              <tbody>
