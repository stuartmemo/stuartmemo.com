...
<%
var rsTourDates = Server.CreateObject("ADODB.Recordset");
rsTourDates.ActiveConnection = MM_Bis_STRING;
rsTourDates.Source = "SELECT * FROM Tour ORDER BY calendar ASC";
rsTourDates.CursorType = 0;
rsTourDates.CursorLocation = 2;
rsTourDates.LockType = 3;
rsTourDates.Open();
var rsTourDates_numRows = 0;
%>
<%
var Repeat1__numRows = -1;
var Repeat1__index = 0;
rsTourDates_numRows += Repeat1__numRows;
%>
  ...
  <tr>
    <td><table width="584" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="437"><img src="images/header_live.gif" alt="" width="437" height="33" /></td>
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="4" bordercolor="#CCCCCC" bgcolor="a39a7b" class="text">
                    <tr> 
                      ...
                      <td valign="top" width="500" class="title"><% while ((Repeat1__numRows-- != 0) && (!rsTourDates.EOF)) { %>
                        <span class="dateline"><%=(rsTourDates.Fields.Item("calendar").Value)%></span><br /><span class="headline">
                        <%=(rsTourDates.Fields.Item("venue").Value)%> <br /></span>
                        <span class="bodycopy"> <%=(rsTourDates.Fields.Item("city").Value)%>,&nbsp;<%=(rsTourDates.Fields.Item("country").Value)%><br />
                        <%=(rsTourDates.Fields.Item("comments").Value)%></span><br />
                        <br>
                        <%
  Repeat1__index++;
  rsTourDates.MoveNext();
}
%></td>
                    </tr>
                    <tbody>
