...
<body bgcolor="#FFFFFF" text="#000000" style="copy" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<% while ((Repeat1__numRows-- != 0) && (!rsLyrics.EOF)) { %>
<A HREF="/lyricsdetail.asp?<%= MM_keepURL + ((MM_keepURL!="")?"&":"") + "id=" + rsLyrics.Fields.Item("id").Value %>"><%=(rsLyrics.Fields.Item("title").Value)%><br></A> 
<%
  Repeat1__index++;
  rsLyrics.MoveNext();
}
