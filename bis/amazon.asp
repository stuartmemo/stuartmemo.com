  ...
  <tr> 
    ...
    <td valign=top width=500> 
      <table class=text cellspacing=4 cellpadding=0 width=500 border=0>
        <tr> 
          <td valign=top width=500 class="title"><strong>Pre-order from Amazon</strong>
            <p> 
          </td>
        </tr>
        <tbody> 
...
<p>     
	Much to my surprise, the greatest hits, 'we are bis from glasgow, scotland' is available for pre-order on <a href="http://www.amazon.co.uk/We-Are-Bis-Glasgow-Scotland/dp/B000NVL992/ref=sr_1_1/203-7069036-1326321?ie=UTF8&s=music&qid=1175006399&sr=8-1">Amazon</a>.
	<p>It says the release date is 2nd April which is wrong as it's the 9th.  A nice 11.99 though, which I'm very happy about as it's CD and DVD with fancy packaging.  Thumbs up to Cherry Red!
</p>
