  ...
  <tr> 
    ...
    <td valign=top width=500> 
      <table class=text cellspacing=4 cellpadding=0 width=500 border=0>
        <tr> 
          <td valign=top width=500 class="title"><h3>Bis play Hogmany show</h3>
            <p> 
          </td>
        </tr>
        <tbody> 
...
<p>     
We will be appearing at the special New Year's Eve event at the ABC 1 in Glasgow on 31st December from 11.30 - midnight.  Other bands are Bleachie (Blondie covers band), Errors, Triplevision, and the ABC resident DJs.  Tickets can be bought via the ABC website at </p><p><a href="http://www.abcglasgow.com/events.html" style="font-size:14px;">http://www.abcglasgow.com/events.html</a>.</p><p> Should be a fun night, so hopefully see you there for some partying!
          </td>
        </tr>
        </tbody> 
      </table>
