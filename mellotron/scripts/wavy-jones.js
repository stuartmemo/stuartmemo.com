...
var WavyJones = function (context, elem) {
    var analyser = context.createAnalyser(),
        ...
        oldFreqData = new Uint8Array(analyser.frequencyBinCount);
    ...
    var drawLine = function () {
        ...
        if (freqData[10] !== oldFreqData[10]) {
            ...
            oscLine.setAttribute('d',
                'M0,' + (analyser.height / 2) + ' ' +
                analyser.width + ',' + (analyser.height / 2)
            );
        }

        oldFreqData[10] = freqData[10];
